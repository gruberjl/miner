...
var parser = function(name) {
  ...
  if (util.isBlank(name)) {
    if (parsedName.prefix == null) parsedName.prefix = ''
    if (parsedName.first == null) parsedName.first = ''
    if (parsedName.middle == null) parsedName.middle = ''
    if (parsedName.last == null) parsedName.last = ''
    if (parsedName.suffix == null) parsedName.suffix = ''
    if (parsedName.original == null) parsedName.original = ''
    return parsedName;
  }
